 ...
 * FILL ME
 * <p/>
 * This class equivalent was called GlobusCredential in CoG -maybe a better
 * name?
 * 
...
public class X509Credential {
	...
	// COMMENT Used to be "key cert cert cert ...", which is wrong afaik. must
	// be "cert key cert cert ..."
	 ...
	 * 
	 * @return strength of the key in bits. Returns -1 if unable to determine
	 *         it.
	 */
	 ...
	 * Returns -1 if unable to determine the certificate type (an error
	 * occurred)
	 * 
	 * @see BouncyCastleUtil#getCertificateType(X509Certificate)
	 * 
	 * @return the type of first certificate in the chain. -1 if unable to
	...
	/**
	 * Returns time left of this credential. The time left of the credential is
	 * based on the certificate with the shortest validity time.
	 * 
	 ...
	 * 
	 * @return The identity cert in Globus format (e.g. /C=US/..). Null, if
	 *         unable to get the identity (an error occurred)
	 */
	 ...
	 * certificate is the first certificate in the chain that is not an
	 * impersonation proxy certificate.
	 * 
	 * @return <code>X509Certificate</code> the identity cert. Null, if unable
	 *         to get the identity certificate (an error occurred)
	 */
