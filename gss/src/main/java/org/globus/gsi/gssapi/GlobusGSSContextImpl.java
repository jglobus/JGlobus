...
public class GlobusGSSContextImpl implements ExtendedGSSContext {
	...
	private void setCredential() throws GSSException {
		try {
			...
			// keyStore.store(new FileOutputStream("/tmp/dorian.p12"),
			// "test".toCharArray());
			// System.setProperty("javax.net.ssl.keyStore", "/tmp/dorian.p12");
	...
	// GlobusGSSException.BAD_OPTION_TYPE, "badType", new Object[]
	// {"Trusted certificates", TrustedCertificates.class}); }
