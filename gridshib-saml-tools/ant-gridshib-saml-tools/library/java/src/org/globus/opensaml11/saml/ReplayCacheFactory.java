...
public class ReplayCacheFactory
{
    ...
    public static ReplayCache getInstance() throws NoSuchProviderException {
        return getInstance(null, SAMLConfig.instance().getProperty("org.globus.opensaml11.saml.provider.replaycache"));
    }
    ...
    public static ReplayCache getInstance(Element e) throws NoSuchProviderException {
        return getInstance(e, SAMLConfig.instance().getProperty("org.globus.opensaml11.saml.provider.replaycache"));
    }
